...
export const DEFAULT_CLIENTS: ClientRecord[] = [
  {
    ...
    subtitle:
      "في مجموعة المحروسة غرف وأجنحة بمعايير ضيافة عالية – احجز مسبقاً واستمتع بإقامة مريحة في قلب الرياض.",
    type: "hotel",
    phone: "0551234567",
    ...
    demoNotice:
      "✨ عرض تجريبي حي – مثال: مجموعة المحروسة للشقق الفندقية على منصة مكّن",

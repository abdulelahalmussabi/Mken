...
// ─── SVG Vector Paths & Colors for Neon Styling ─────────────────────────────
...
export function NeonSocialGlyph({
  ...
  return (
    ...
    >
      ...
      {/* ─── PLATFORMS SVG NEON OUTLINES ─── */}

      {/* 1. X (formerly Twitter) - Neon Modern 𝕏 + Bird Style */}
      {platform === "twitter" && (

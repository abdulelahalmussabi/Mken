  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#090d16] text-slate-100 font-sans">
      ...
      <main className="flex-1 flex items-center justify-center py-12 px-4 sm:px-6">
        <div className={`w-full max-w-md ${activeOccasion !== "none" ? occasionDetails.badgeBg : "bg-slate-900/90 border-slate-800"} border rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6`}>
          {/* Header */}
          <div className="text-center space-y-2">
            ...
            <h1 className="text-2xl font-extrabold text-white">تسجيل الدخول إلى منصة مكّن</h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-xl text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all text-sm dir-ltr text-right"
              />
              {errors.email && (
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <label htmlFor="password" className="block text-xs font-bold text-slate-300 flex items-center gap-1.5">
